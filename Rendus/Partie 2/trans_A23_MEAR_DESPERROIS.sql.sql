DROP SCHEMA IF EXISTS transmusical_a23 CASCADE;

create schema transmusical_a23;

set schema 'transmusical_a23';
...
CREATE TABLE IF NOT EXISTS Groupe_artiste (
    ...
    annee_sortie_disco INTEGER NOT NULL,
    nom_p VARCHAR(50) NOT NULL,


    CONSTRAINT Groupe_artiste_pk 
        PRIMARY KEY (Id_Groupe_Artiste),
    CONSTRAINT Groupe_artiste_Annee_Debut_fk
        FOREIGN KEY (annee_debut) REFERENCES Annee(an),
    CONSTRAINT Groupe_artiste_Annee_Sortie_Disco_fk
		FOREIGN KEY (annee_sortie_disco) REFERENCES Annee(an),
...
Create table IF NOT EXISTS Groupe_artiste_Formation(
    id_Groupe_Artiste VARCHAR(50),
    libelle_formation VARCHAR(50),
...
CREATE table  IF NOT EXISTS type_ponctuel(
      id_Groupe_Artiste VARCHAR(50),
      type_m VARCHAR(50),
